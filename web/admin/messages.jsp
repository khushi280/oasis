        ...
        <div id="page-wrapper" >
            <div id="page-inner">
			 <div class="row">
                 ...
                 <!-- /. ROW  -->
				 <%
				String mail = "SELECT * FROM contact";
				ps=c.prepareStatement(mail);
				rs=ps.executeQuery();
			   ...
			   %>
                ...
                <div class="col-md-12">
                    <div class="jumbotron">
						...
						while(rs.next())
						{
							String app=rs.getString("approval");
							if(app.equals("Allowed"))
							{
						...
						<div class="panel-body">
							...
							{	
								...
								String log ="INSERT INTO newsletterlog(title, subject, news) VALUES ('"+title+"','"+subject+"','"+news+"')";
								ps=c.prepareStatement(log);
										...
										while(rs.next())
										{
											...
											{%>
												<tr class='gradeC'>
													...
													<td><a href="newsletter.jsp?eid=<%=id%>" <button class='btn btn-primary'> <i class='fa fa-edit' ></i> Permission</button></td>
													<td><a href="newsletterdel.jsp?eid=<%=id%>" <button class='btn btn-danger'> <i class='fa fa-edit' ></i> Delete</button></td>
												</tr>
											<%}
											else
											{%>
