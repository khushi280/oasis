    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="home.jsp"><i class="fa fa-dashboard"></i> Status</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
			...
			<%
				...
				ps=c.prepareStatement(q2,ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
						...
						int id = rs.getInt("id");%>
											...
											<div class='col-md-3 col-sm-12 col-xs-12'>
													<div class='panel panel-primary text-center no-boder bg-color-blue'>
														...
														<a href="show.jsp?sid=<%=id%>"><button  class='btn btn-primary btn' data-toggle='modal' data-target='#myModal'>
													Show
													</button></a>
															<%=rs.getString("troom")%>
				...
				String fsql = "SELECT * FROM contact";
				ps=c.prepareStatement(fsql,ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
				rs=ps.executeQuery();	
				rs.last();
				int f=rs.getRow();
				rs.first();
				...
				%>
					<tr>
						...
						<th><%=rs.getString("email")%></th>
						<th><%=rs.getString("cdate")%></th>
						<th><%=rs.getString("approval")%></th>
					</tr>
				...
				%>
								...
								<a href="messages.jsp" class="btn btn-primary">More Action</a>
                            </div>
                        </div>
                    </div>
                                        </div>
